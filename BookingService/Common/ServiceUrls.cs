namespace BookingService.Common
{
    ...
    {
        public const string HOTEL_URL = "https://alekshotels.herokuapp.com/hotels/booking";
    ...
    {
        public const string HOTEL_URL = "https://alekshotels.herokuapp.com/hotels/buyout";
